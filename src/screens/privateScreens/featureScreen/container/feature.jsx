          ...
          const isAdminOrManager =
            ...
            : features.filter((feature) => {
                if (user.role === "QA_ENGINEER") {
                  return feature.qaEngineer?.userId === user?.userId; 
                }
                return feature.assignedTo?.userId === user?.userId; 
              });
            ...
            <div className="p-6 bg-gradient-to-br from-sky-50 to-teal-50 min-h-screen relative">
              <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button
                    className="p-2 px-4 text-white rounded-lg shadow-md 
                    bg-teal-600 hover:bg-teal-700 transition-all duration-300"
                ...
                {isAdminOrManager && (
                  <button
                    ...
                    bg-teal-600 hover:bg-teal-700 transition-transform transform hover:scale-105"
